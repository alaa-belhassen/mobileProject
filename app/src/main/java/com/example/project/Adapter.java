...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    public Adapter(Context context, ArrayList name_id, ArrayList email_id, ArrayList age_id) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            email_id = itemView.findViewById(R.id.vehiculeT);
            age_id = itemView.findViewById(R.id.receipt);
        }
    }
}
